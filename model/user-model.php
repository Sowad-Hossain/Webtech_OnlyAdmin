...
{
    $conn = conn();
    $query = "INSERT INTO users (username, email, password, role, status, full_name, nid, address, mobile_number) VALUES ('$username', '$email', '$password', '$role', '$status', '$full_name', '$nid', '$address', '$mobile_number')";
